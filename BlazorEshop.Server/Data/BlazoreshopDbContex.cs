namespace BlazorEshop.Server.Data
{
    public class BlazoreshopDbContex : DbContext
    {
        public BlazoreshopDbContex(DbContextOptions<BlazoreshopDbContex> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product
                {
                    ...
                    ImageUrl = "https://upload.wikimedia.org/wikipedia/ga/thumb/c/c3/1984first.jpg/403px-1984first.jpg",
                    CategoryId = 1
                },
                 new Product
                 {
